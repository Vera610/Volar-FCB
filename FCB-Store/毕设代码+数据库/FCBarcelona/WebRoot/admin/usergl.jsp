...
<html>
	...
	<%
		...
		String hql = " from Sysuser where type not in('用户') ";
		String url = "/FCBarcelona/admin/usergl.jsp?1=1";
	...
	<body>
		...
		<form action="/FCBarcelona/admin/usergl.jsp?f=f" name="f1"
			method="post">
			<table cellspacing=1 cellpadding=3 align=left>
				<tr>
					<td height=25 valign=middle>
						...
						</a><font style="font-family: 黑体"> / 管理员管理 
					</td>
				</tr>
			</table>
			<br>
			...
			<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
				...
				<%
					...
					PageManager pageManager = PageManager.getPage(
							"/FCBarcelona/admin/usergl.jsp?1=1", 10, request);
				...
				<tr>
					...
					<td class=tablebody1 valign=middle align=center width="">
						<a href="javascript:edit(<%=sysuser.getId()%>)" style="text-decoration: none"><font color="#830721">编辑</font></a>
...
<script type="text/javascript">
	...
	function edit(id)
	{
		pop("/FCBarcelona/admin/useredit.jsp?id="+id,"编辑",710,270);
	}
</script>